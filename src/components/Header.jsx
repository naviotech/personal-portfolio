  ...
  return (
    <header className="flex flex-col items-center justify-center p-4 md:px-10 lg:px-20 font-inter dark:bg-dark-default">
      <nav className="flex items-center justify-between w-full max-w-screen-xl dark:bg-dark-default">
        <h1 className="text-2xl font-bold dark:text-dark-title"><a href="">{"<EN />"}</a></h1>

        <input type="checkbox" id="menu" className="hidden peer/menu"/>
        <label htmlFor="menu" className="z-20 w-10 h-10 transition-all duration-100 bg-center bg-cover rounded-lg cursor-pointer dark:bg-menu-burguer-dark bg-menu-burguer bg-green-color peer-checked/menu:bg-menu-close dark:peer-checked/menu:bg-menu-close-dark md:hidden"></label>
        ...
        <div className="drop hidden h-full w-[100%] absolute right-0 top-0 z-10 p-4 bg-white dark:bg-dark-default peer-checked/menu:block transition-all md:flex md:flex-row md:gap-4 md:relative md:w-[85%] md:h-auto md:bg-none md:justify-end md:text-sm md:items-center lg:gap-12">
          <h2 className="py-1 mb-6 text-2xl font-bold md:hidden dark:text-dark-title"><a href="">{"<EN />"}</a></h2>
          ...
          <ul className="flex flex-col justify-center items-center gap-2 text-xl mt-6 mb-6 md:flex-row md:p-3 md:gap-2 lg:gap-6 lg:max-w-[60%]">
            <li className="text-gray-500 transition-all duration-200 cursor-pointer hover:text-black hover:transform md:text-base lg:text-lg lg:text-black lg:hover:font-bold dark:text-dark-title dark:hover:scale-110 dark:hover:text-dark-title"><a href="#about">{t("header.about")}</a></li>
            <li className="text-gray-500 transition-all duration-200 cursor-pointer hover:text-black hover:transform md:text-base lg:text-lg lg:text-black lg:hover:font-bold dark:text-dark-title dark:hover:scale-110 dark:hover:text-dark-title"><a href="#projects">{t("header.projects")}</a></li>
            <li className="text-gray-500 transition-all duration-200 cursor-pointer hover:text-black hover:transform md:text-base lg:text-lg lg:text-black lg:hover:font-bold dark:text-dark-title dark:hover:scale-110 dark:hover:text-dark-title"><a href="#education">{t("header.education")}</a></li>
            <li className="text-gray-500 transition-all duration-200 cursor-pointer hover:text-black hover:transform md:text-base lg:text-lg lg:text-black lg:hover:font-bold dark:text-dark-title dark:hover:scale-110 dark:hover:text-dark-title"><a href="#contact">{t("header.contatc")}</a></li>
          </ul>
          <hr className="md:hidden"/>
          <div className="flex items-center justify-between">
            {theme === "light" && (
              <div onClick={handleSun} className="flex justify-center w-full mt-6 mb-6 cursor-pointer">
                <svg className="transition-transform duration-200 cursor-pointer hover:transform hover:scale-110" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center justify-center w-full cursor-pointer md:hidden">
            <a href="/cv.pdf" download={"cv.pdf"} className="min-w-full py-2 font-bold text-center text-white bg-gray-900 rounded-lg dark:bg-dark-title dark:text-black hover:bg-gray-900/50 hover:text-black md:text-sm dark:hover:bg-slate-500 dark:hover:text-dark-title">{t("header.cv")}</a>
          </div>
      ...
      <section className="flex flex-col items-center justify-center w-full max-w-screen-xl gap-12 py-16 md:flex-row-reverse md:items-center md:justify-center md:gap-0">
        ...
        <article className="md:w-[60%]">
          <h1 className="mb-2 text-2xl lg:text-4xl dark:text-dark-title">{t("header.soy")} <strong>Edu</strong> 🙋🏼‍♂️,</h1>
          ...
          <div className="flex items-center justify-start gap-4 mt-6 mb-6">
            <a href="https://github.com/naviotech" target="_blank" className="transition-all hover:scale-110"><img src="./svg/git.svg"></img></a>
            <a href="https://www.linkedin.com/in/naviomaya" target="_blank" className="transition-all hover:scale-110"><img src="./svg/linkedin.svg"></img></a>
            <a href="mailto:naviomaya@gmail.com" target="_blank" className="transition-all hover:scale-110"><img src="./svg/mail.svg"></img></a>
          </div>
          <div className="md:w-[40%] hidden  md:justify-center md:flex md:items-center cursor-pointer">
            <a href="/cv.pdf" download={"cv.pdf"} className="min-w-full py-3 font-bold text-center text-white bg-gray-900 rounded-lg dark:bg-dark-title dark:text-black hover:bg-gray-900/50 hover:text-black md:text-sm dark:hover:bg-slate-500 dark:hover:text-dark-title">{t("header.cv")}</a>
          </div>
        </article>
      </section>
