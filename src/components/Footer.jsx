...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col items-center justify-center p-4 md:px-10 lg:px-20 font-inter dark:bg-dark-default">
      <section className="relative flex flex-col items-center justify-center w-full p-4 py-16 md:px-10 lg:px-20 max-w-screen-2xl dark:bg-dark-default">
        <h2 id="contact" className="mb-6 text-2xl font-bold text-center md:mb-20 md:text-2xl xl:text-3xl dark:text-dark-title">{t("footer.contact")}</h2>
        ...
        <p className="flex items-center justify-center gap-3 font-extrabold dark:text-dark-title">enavio.tech@gmail.com 
          <span className="transition-all cursor-pointer hover:scale-110" onClick={handleCopy}>
        ...
        <nav className="flex items-center justify-center w-full max-w-screen-xl">
          <div className="flex items-center justify-start gap-4 mt-6">
            ...
            <a href="mailto:enavio.tech@gmail.com " target="_blank" className="transition-all hover:scale-110"><img src="./svg/mail.svg"></img></a>
          </div>
      </nav>
      </section>
    </footer>
